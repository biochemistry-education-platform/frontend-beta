<template>
    <div class="side-menu">
        ...
        <div class="menu-items">
            ...
            <router-link :to="{name: 'MyArticles'}" class="menu-item my-articles-block" :class="current_item == 'MyArticles' ? 'active' : ''">
            ...
            <router-link :to="{name: 'ArticlesForChecking'}" class="menu-item check-articles-block" :class="current_item == 'ArticlesForChecking' ? 'active' : ''">
            ...
            <div class="menu-item create-article-block" :class="current_item == 'AddArticle' ? 'active' : (current_item == 'ChoosingType' ? 'choosing' : '')" @click="showArticleTypes">
                ...
                <div v-if="articleTypes" class="article-types-block">
                    <router-link :to="{ name: 'AddArticle', params: { type: 'text' }}" class="article-type-item">{{ $t('textArticle') }}</router-link>
                    <router-link :to="{ name: 'AddArticle', params: { type: 'notification' }}" class="article-type-item">{{ $t('notifArticle') }}</router-link>
                    <router-link :to="{ name: 'AddArticle', params: { type: 'recommend' }}" class="article-type-item">{{ $t('recomArticle') }}</router-link>
                </div>
            </div>
