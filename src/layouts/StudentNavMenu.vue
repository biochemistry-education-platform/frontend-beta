<template>
    <div class="side-menu">
        ...
        <div class="menu-items">
            ...
            <router-link :to="{name: 'MyArticles'}" class="menu-item check-articles-block" :class="current_item == 'MyArticles' ? 'active' : ''">
            ...
            <router-link :to="{name: 'AddArticle', params: { type: 'text' }}" class="menu-item create-article-block" :class="current_item == 'AddArticle' ? 'active' : ''">
