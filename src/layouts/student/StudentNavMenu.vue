    ...
    <div class="side-menu">
        ...
        <div class="menu-items">
            <div class="menu-item profile-block">
                ...
                <router-link :to="{name: 'StudentProfile'}" class="item-text profile-item-text">{{ $t('profile') }}</router-link>
            </div>
            <div class="menu-item feed-block active">
                ...
                <router-link :to="{name: 'ArticlesPageStudent'}" class="item-text feed-item-text">{{ $t('feed') }}</router-link>
            </div>
