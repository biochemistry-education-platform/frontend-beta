<template>
    <div class="side-menu">
        ...
        <div class="sss-menu-items">
            <router-link :to="{name: 'Profile'}" class="sss-menu-item profile-block">
            ...
            <router-link :to="{name: 'Articles'}" class="sss-menu-item feed-block active">
            ...
            <div class="sss-menu-item my-notes-block">
            ...
            <div class="sss-menu-item my-articles-block">
                <svg class="my-article-icon menu-svg" xmlns="http://www.w3.org/2000/svg" height="48" viewBox="0 96 960 960" width="48"><path d="M277 777h275v-60H277v60Zm0-171h406v-60H277v60Zm0-171h406v-60H277v60Zm-97 501q-24 0-42-18t-18-42V276q0-24 18-42t42-18h600q24 0 42 18t18 42v600q0 24-18 42t-42 18H180Zm0-60h600V276H180v600Zm0-600v600-600Z"/></svg>
                <p class="item-text my-article-item-text">{{ $t('myArticles') }}</p>
            </div>
            <div class="sss-menu-item check-articles-block">
            ...
            <div class="sss-menu-item create-article-block">
            ...
            <div class="sss-menu-item favorite-block">
        ...
        <div class="menu-switches">
            <div class="language-block">
                ...
                <p v-if="language === 'ru'" class="language-name" @click="switchLanguage">RU</p>
                <p v-else class="language-name" @click="switchLanguage">EN</p>
            </div>
