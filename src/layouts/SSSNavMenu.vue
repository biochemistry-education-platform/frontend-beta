<template>
    <div class="side-menu">
        ...
        <div class="sss-menu-items">
            <router-link :to="{name: 'Profile'}" class="sss-menu-item profile-block" :class="current_item == 'Profile' ? 'active' : ''">
            ...
            <router-link :to="{name: 'Articles'}" class="sss-menu-item feed-block" :class="current_item == 'Articles' ? 'active' : ''">
            ...
            <router-link :to="{name: 'Notes'}" class="sss-menu-item my-notes-block" :class="current_item == 'Notes' ? 'active' : ''">
            ...
            <router-link :to="{name: 'MyArticles'}" class="sss-menu-item my-articles-block" :class="current_item == 'MyArticles' ? 'active' : ''">
                <svg class="my-article-icon menu-svg" xmlns="http://www.w3.org/2000/svg" height="48" viewBox="0 96 960 960" width="48"><path d="M277 777h275v-60H277v60Zm0-171h406v-60H277v60Zm0-171h406v-60H277v60Zm-97 501q-24 0-42-18t-18-42V276q0-24 18-42t42-18h600q24 0 42 18t18 42v600q0 24-18 42t-42 18H180Zm0-60h600V276H180v600Zm0-600v600-600Z"/></svg>
                <p class="item-text my-article-item-text">{{ $t('myArticles') }}</p>
            </router-link>
            <router-link :to="{name: 'ArticlesForChecking'}" class="sss-menu-item check-articles-block" :class="current_item == 'ArticlesForChecking' ? 'active' : ''">
            ...
            <div class="sss-menu-item create-article-block" :class="current_item == 'AddArticle' ? 'active' : (current_item == 'ChoosingType' ? 'choosing' : '')" @click="showArticleTypes">
                ...
                <div v-if="articleTypes" class="article-types-block-sss">
...
.sss-menu-items {
    ...
    margin-top: calc((100vh - 149px - (97px * 7)) / 8);
    align-items: center;
    text-align: center;
}

.sss-menu-item{
    margin-bottom: calc((100vh - 149px - (97px * 7)) / 8);
    width: calc(100% - 32px);
    padding-top: 20px;
    padding-bottom: 20px;
...
.article-types-block-sss::before {
    content: '';
    width: 36px;
    height: 36px;
    top: -15.4px;
