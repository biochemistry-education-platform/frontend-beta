    ...
    <div class="side-menu">
        ...
        <div class="menu-items">
            <div class="menu-item profile-block">
                ...
                <router-link :to="{name: 'MyAccount'}" class="item-text profile-item-text">{{ $t('profile') }}</router-link>
            </div>
            ...
            <div class="menu-item create-article-block">
                ...
                <router-link :to="{name: 'AddArticle'}" class="item-text create-article-item-text">{{ $t('createArticle') }}</router-link>
            </div>
