export default {
    ...
    alreadySubscriptedAuthor: 'Невозможно подписаться на автора, на которого Вы уже подписаны',
    ...
    page404: 'Упс! Такой страницы не существует. Но вы можете посмотреть существующие разделы ',
    onFeed: 'на главной странице.'
}
