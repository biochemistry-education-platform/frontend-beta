    ...
    <div class="articles-page">
        ...
        <div class="articles__article" v-for="article in filteredArticles" v-bind:key="article.id">
            ...
            <div class="article__content">
                <!-- если преподаватель, то роутер к ArticleTeacherPage, иначе к ArticleStudentPage -->
                <router-link :to="{ name: 'ArticleTeacherPage', params: { id: article.id }}" class="article__title">{{ article.title }}</router-link>
