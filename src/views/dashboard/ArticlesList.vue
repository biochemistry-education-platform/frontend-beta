        ...
        <div class="articles-list">
            <div class="articles__article" v-for="article in filteredArticles" :key="article.id">
                ...
                <div class="article__content">
                    <router-link v-if="article.type == 'Notification_article'" :to="{ name: 'NotifArticle', params: { id: article.id }}" class="article__title">{{ article.title }}</router-link>
                    <router-link v-else :to="{ name: 'Article', params: { id: article.id }}" class="article__title">{{ article.title }}</router-link>
