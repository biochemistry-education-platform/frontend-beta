    ...
    <div class="biochemistry-page">
        ...
        <div class="articles-list">
            <div class="articles__article" v-for="article in filteredArticles" :key="article.id">
                ...
                <hr v-if="!isMobile" class="article-separator">
                <div v-if="this.$store.state.user.role != 'Student'" class="article-favorite" @click="article.isSaved = !article.isSaved">
                ...
                <div v-if="this.$store.state.user.role == 'Student'" class="article-status">
